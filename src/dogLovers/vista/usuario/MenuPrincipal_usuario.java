...
public class MenuPrincipal_usuario extends JFrame {
	...
	public MenuPrincipal_usuario() {
		...
		principal.add(panelNoticias, gbc_panelNoticias);
		panelNoticias.setSize(225, Principal.getAlto());
		...
		principal.add(panelContenido, gbc_panelContenido);
		...
		lblMenPrincipal = new JLabel("Men\u00FA Principal");
		lblMenPrincipal.setFont(Principal.getLetratexto1());
		...
		panelContenido.add(lblMenPrincipal, gbc_lblMenPrincipal);

		btn_IngMascota = new PanelConFondo("agregar_mascota.png", false);
		...
		panelContenido.add(btn_IngMascota, gbc_btn_IngMascota);

		btn_MisMascotas = new PanelConFondo("huella.png", false);
		...
		panelContenido.add(btn_MisMascotas, gbc_btn_MisMascotas);

		panelSlider = new PanelSlider(new ArrayList<Fotografia>());
		...
		panelContenido.add(panelSlider, gbc_panelSlider);

		lblIngresarMascota = new JLabel("Ingresar mascota");
		lblIngresarMascota.setFont(Principal.getLetratexto3());
		...
		panelContenido.add(lblIngresarMascota, gbc_lblIngresarMascota);

		lblMisMascotas = new JLabel("Mis mascotas");
		...
		panelContenido.add(lblMisMascotas, gbc_lblMisMascotas);

		btn_ActualizarDatos = new PanelConFondo("usuario.png", false);
		...
		panelContenido.add(btn_ActualizarDatos, gbc_btn_ActualizarDatos);

		btn_Consultas = new PanelConFondo("ver.png", false);
		...
		panelContenido.add(btn_Consultas, gbc_btn_Consultas);

		lblActualizarDatos = new JLabel("Actualizar datos");
		lblActualizarDatos.setFont(Principal.getLetratexto3());
		...
		panelContenido.add(lblActualizarDatos, gbc_lblActualizarDatos);

		lblConsultas = new JLabel("Consultas");
		lblConsultas.setFont(Principal.getLetratexto3());
		...
		panelContenido.add(btn_Adopciones, gbc_btn_Adopciones);

		lblCasasCuna = new JLabel("Casas cuna");
		lblCasasCuna.setFont(Principal.getLetratexto3());
		...
		panelContenido.add(lblCasasCuna, gbc_lblCasasCuna);

		lblAdopciones = new JLabel("Adopciones");
		lblAdopciones.setFont(Principal.getLetratexto3());
		...
		panelContenido.add(lblAdopciones, gbc_lblAdopciones);
	}
	/**** MÉTODOS ****/
